...
// ============================================================
// 文件: E:/Github/unsafe_rust_project_all/unsafe_rust_download/download_rs/below_1k/esp-idf-hal/280ae0099a4bc3c8503f26273046dd13746b7a35/src/task.rs
// ============================================================
...
pub mod task {
    ...
    pub mod group_1 {
        // 路径列表:
        // 1.1 pub fn send_front -> fn send_generic
        // 1.2 pub fn send_back -> fn send_generic
    ...
    // 组 2: 通向不安全函数的路径: get_conf
    pub mod group_2 {
        // 路径列表:
        // 2.1 pub fn get -> fn get_conf
        // 函数实现:
        // 公共入口点: thread::get
